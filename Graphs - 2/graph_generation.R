...
figure.5 <- plot.column.dais(figure_5_data, stat, age, group.by=description, label=TRUE,
                             plot.fig.num = figure,
                             plot.title= graph.data[graph.data$Figure_number==figure,Figure_title],
                             y.axis= graph.data[graph.data$Figure_number==figure,Y_Axis],
                             caption = graph.data[graph.data$Figure_number==figure,Caption],
...
figure.7 <- plot.column.dais(figure_7_data, stat, education, group.by=description, label=FALSE,
                             plot.fig.num = figure,
                             plot.title= graph.data[graph.data$Figure_number==figure,Figure_title],
                             y.axis= graph.data[graph.data$Figure_number==figure,Y_Axis],
                             caption = graph.data[graph.data$Figure_number==figure,Caption],
...
figure <- "Figure 8"
figure_8_data <- fread("C:/Users/alockhart/Desktop/Canada's Tech Workers/Graphs - 2/Figure_8.csv") %>% dplyr::filter(!is.na(stat)) %>% as.data.table
figure.8 <- plot.column.dais(figure_8_data, stat, vismin, group.by=description, label=TRUE,
                             plot.fig.num = figure,
                             plot.title= graph.data[graph.data$Figure_number==figure,Figure_title],
                             y.axis= graph.data[graph.data$Figure_number==figure,Y_Axis],
                             caption = graph.data[graph.data$Figure_number==figure,Caption],
...
figure.9 <- plot.column.dais(figure_9_data, stat, vismin, order.bar	="descending", label=TRUE,
                             plot.fig.num = figure,
                             plot.title= graph.data[graph.data$Figure_number==figure,Figure_title],
                             y.axis= graph.data[graph.data$Figure_number==figure,Y_Axis],
                             caption = graph.data[graph.data$Figure_number==figure,Caption],
...
figure.10 <- plot.column.dais(figure_10_data, stat, vismin, group.by=description, label=TRUE,
                             plot.fig.num = figure,
                             plot.title= graph.data[graph.data$Figure_number==figure,Figure_title],
                             y.axis= graph.data[graph.data$Figure_number==figure,Y_Axis],
                             caption = graph.data[graph.data$Figure_number==figure,Caption],
